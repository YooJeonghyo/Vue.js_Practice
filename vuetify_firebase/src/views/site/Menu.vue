  ...
  <div>
    <v-list-item three-line>
      ...
      <v-list-item-action>
        <v-btn
          icon
          @click="$store.commit('setEdit', !$store.state.editable)"
        >
          <v-icon v-text="$store.state.editable ? 'mdi-eye' : 'mdi-pencil'" />
        </v-btn>
      </v-list-item-action>
    </v-list-item>
    <v-divider />
